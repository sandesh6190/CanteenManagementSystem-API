...
{
    /// <inheritdoc />
    public partial class UserBalanceMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RedeemTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RedeemTypes_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RedeemTypes_AspNetUsers_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NotificationStatuses_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RedeemTypeId = table.Column<int>(type: "int", nullable: false),
                    IsUsed = table.Column<bool>(type: "bit", nullable: false),
                    RedeemNo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedById = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    UpdatedById = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreatedDateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDateTime = table.Column<DateTime>(type: "datetime2", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Redeems_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Redeems_AspNetUsers_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Redeems_RedeemTypes_RedeemTypeId",
                        column: x => x.RedeemTypeId,
                        principalTable: "RedeemTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationStatuses_UserId",
                table: "NotificationStatuses",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Redeems_CreatedById",
                table: "Redeems",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_Redeems_RedeemTypeId",
                table: "Redeems",
                column: "RedeemTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Redeems_UpdatedById",
                table: "Redeems",
                column: "UpdatedById");

            migrationBuilder.CreateIndex(
                name: "IX_RedeemTypes_CreatedById",
                table: "RedeemTypes",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_RedeemTypes_UpdatedById",
                table: "RedeemTypes",
                column: "UpdatedById");
